...
module EgoiRubyClient
  class VoiceApi
    ...
    # @param campaign_voice_send_request [CampaignVoiceSendRequest] Parameters for the &#39;send voice&#39; action
    ...
    def action_send_voice_with_http_info(campaign_hash, campaign_voice_send_request, opts = {})
      ...
      if @api_client.config.client_side_validation && campaign_hash !~ pattern
        fail ArgumentError, "invalid value for 'campaign_hash' when calling VoiceApi.action_send_voice, must conform to the pattern #{pattern}."
      end
      ...
      # resource path
      local_var_path = '/campaigns/voice/{campaign_hash}/actions/send'.sub('{' + 'campaign_hash' + '}', CGI.escape(campaign_hash.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(campaign_voice_send_request)
      ...
      new_options = opts.merge(
        :operation => :"VoiceApi.action_send_voice",
    ...
    # @param voice_campaign [VoiceCampaign] Parameters for the Voice Campaign
    # @param [Hash] opts the optional parameters
    # @return [CampaignHash]
    ...
    # @param voice_campaign [VoiceCampaign] Parameters for the Voice Campaign
    # @param [Hash] opts the optional parameters
    # @return [Array<(CampaignHash, Integer, Hash)>] CampaignHash data, response status code and response headers
    def create_voice_campaign_with_http_info(voice_campaign, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(voice_campaign)

      # return_type
      return_type = opts[:debug_return_type] || 'CampaignHash'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Apikey']

      new_options = opts.merge(
        :operation => :"VoiceApi.create_voice_campaign",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param campaign_hash [String] Hash of the Campaign
    # @param voice_patch_campaign [VoicePatchCampaign] Parameters for the Voice Campaign
    # @param [Hash] opts the optional parameters
    ...
    def patch_voice_campaign_with_http_info(campaign_hash, voice_patch_campaign, opts = {})
      ...
      pattern = Regexp.new(/[a-zA-Z0-9_-]*/)
      if @api_client.config.client_side_validation && campaign_hash !~ pattern
        fail ArgumentError, "invalid value for 'campaign_hash' when calling VoiceApi.patch_voice_campaign, must conform to the pattern #{pattern}."
      end
      ...
      # resource path
      local_var_path = '/campaigns/voice/{campaign_hash}'.sub('{' + 'campaign_hash' + '}', CGI.escape(campaign_hash.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(voice_patch_campaign)
      ...
      new_options = opts.merge(
        :operation => :"VoiceApi.patch_voice_campaign",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
