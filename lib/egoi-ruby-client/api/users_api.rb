  ...
  class UsersApi
    ...
    def delete_user_with_http_info(user_id, opts = {})
      ...
      if @api_client.config.client_side_validation && user_id < 1
        fail ArgumentError, 'invalid value for "user_id" when calling UsersApi.delete_user, must be greater than or equal to 1.'
      end
    ...
    def get_all_users_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling UsersApi.get_all_users, must be smaller than or equal to 1000.'
      end
      ...
      allowable_values = ["user_id", "username"]
      ...
      new_options = opts.merge(
        :operation => :"UsersApi.get_all_users",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
