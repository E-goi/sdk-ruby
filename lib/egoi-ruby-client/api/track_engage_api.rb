  ...
  class TrackEngageApi
    ...
    def get_all_domains_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"TrackEngageApi.get_all_domains",
    ...
    # Returns all goals
    # @param [Hash] opts the optional parameters
    # @return [Array<(GoalCollection, Integer, Hash)>] GoalCollection data, response status code and response headers
    def get_all_goals_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GoalCollection'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Apikey']

      new_options = opts.merge(
        :operation => :"TrackEngageApi.get_all_goals",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
