  ...
  class SendersApi
    ...
    def get_all_cellphone_senders_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling SendersApi.get_all_cellphone_senders, must be smaller than or equal to 1000.'
      end
    ...
    def get_all_email_senders_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling SendersApi.get_all_email_senders, must be smaller than or equal to 1000.'
      end
    ...
    def get_all_phone_senders_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling SendersApi.get_all_phone_senders, must be smaller than or equal to 1000.'
      end
