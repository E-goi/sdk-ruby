...
module EgoiRubyClient
  ...
  class ContactCampaignActivity
    ...
    def self.openapi_types
      {
        :'action_data' => :'ContactCampaignActivityAllOfActionData',
        :'date' => :'Time',
        :'action_name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EgoiRubyClient::ContactCampaignActivity` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EgoiRubyClient::ContactCampaignActivity`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def action_name=(action_name)
      validator = EnumAttributeValidator.new('String', ["email_open", "forward", "email_send", "sms_send", "voice_send", "sms_report", "voice_report", "invitation_send", "invitation_open", "email_soft_bounce", "email_hard_bounce", "double_optin", "double_optin_resend", "email_spam_complaint", "double_optedit", "push_send", "push_open", "push_received", "push_error", "push_canceled", "reply_to_email", "web_push_send", "web_push_delivered", "web_push_open", "web_push_bounce", "voice_menu_event", "voice_redirect", "push_delivered", "smart_sms_send", "smart_sms_open", "smart_sms_report"])
