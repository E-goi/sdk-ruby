...
module EgoiRubyClient
  class HeaderFooterFooterLinks
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'view_web')
    ...
    def hash
      [forward, view_web, unsubscribe, footer_links, social_share, facebook_share, twitter_share].hash
    end
