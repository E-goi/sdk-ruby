  ...
  class Webhook
    ...
    def self.openapi_types
      {
        ...
        :'list_id' => :'Integer',
        :'url' => :'String',
        :'actions' => :'Array<WebhookActionSchema>',
        :'fields' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EgoiRubyClient::Webhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EgoiRubyClient::Webhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@webhook_id.nil? && @webhook_id < 1
        invalid_properties.push('invalid value for "webhook_id", must be greater than or equal to 1.')
      end
    ...
    def valid?
      return false if !@webhook_id.nil? && @webhook_id < 1
    ...
    def webhook_id=(webhook_id)
      if !webhook_id.nil? && webhook_id < 1
        fail ArgumentError, 'invalid value for "webhook_id", must be greater than or equal to 1.'
      end
    ...
    def hash
      [webhook_id, list_id, url, actions, fields].hash
    end
