...
module EgoiRubyClient
  ...
  class GenerateSubscriptionsReport
    ...
    def list_invalid_properties
      ...
      if @lists < 1
        invalid_properties.push('invalid value for "lists", must be greater than or equal to 1.')
      end
    ...
    # @param [Object] lists Value to be assigned
    def lists=(lists)
      if lists.nil?
        fail ArgumentError, 'lists cannot be nil'
      end

      if lists < 1
        fail ArgumentError, 'invalid value for "lists", must be greater than or equal to 1.'
      end
