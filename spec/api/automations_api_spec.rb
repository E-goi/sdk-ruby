...
# Unit tests for EgoiRubyClient::AutomationsApi
...
describe 'AutomationsApi' do
  ...
  describe 'test an instance of AutomationsApi' do
    it 'should create an instance of AutomationsApi' do
      expect(@api_instance).to be_instance_of(EgoiRubyClient::AutomationsApi)
    end
  end
  ...
  # @return [nil]
  describe 'delete_automation test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_all_actions
  ...
  describe 'get_all_actions test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_all_automations
  # Get all automations
  ...
  describe 'get_all_automations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
