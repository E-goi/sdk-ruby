...
# Unit tests for EgoiRubyClient::WebpushApi
...
describe 'WebpushApi' do
  ...
  describe 'test an instance of WebpushApi' do
    it 'should create an instance of WebpushApi' do
      expect(@api_instance).to be_instance_of(EgoiRubyClient::WebpushApi)
    end
  end

  # unit tests for action_enable_web_push_rss
  # Enable a rss webpush campaign
  # Enable rss webpush message
  # @param campaign_hash Hash of the Campaign
  # @param [Hash] opts the optional parameters
  # @return [AcceptedResponse]
  describe 'action_enable_web_push_rss test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for action_send_web_push
  ...
  # @param [Hash] opts the optional parameters
  # @return [AcceptedResponse]
  describe 'action_send_web_push test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_web_push_campaign
  ...
  describe 'create_web_push_campaign test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_web_push_rss_campaign
  ...
  describe 'create_web_push_rss_campaign test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_webpush_site
  # Creates a webpush site
  # Create a new webpush site
  # @param web_push_site Parameters for the webpush site
  # @param [Hash] opts the optional parameters
  # @return [WebPushSite]
  describe 'create_webpush_site test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_all_web_push_sites
  ...
  describe 'get_all_web_push_sites test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_web_push_campaign
  ...
  # @param [Hash] opts the optional parameters
  # @return [PatchVoiceCampaign200Response]
  describe 'patch_web_push_campaign test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
