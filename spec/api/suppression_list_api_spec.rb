...
describe 'SuppressionListApi' do
  ...
  describe 'test an instance of SuppressionListApi' do
    it 'should create an instance of SuppressionListApi' do
      expect(@api_instance).to be_instance_of(EgoiRubyClient::SuppressionListApi)
    end
  end

  # unit tests for create_suppression_list
  # Add to suppression list
  # Adds a collection of values to the suppression list
  # @param create_suppression_list_request Parameters for the request
  # @param [Hash] opts the optional parameters
  # @return [AcceptedResponse]
  describe 'create_suppression_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_suppression_list
  # Delete from suppression list
  # Deletes a suppression list value given its ID if it&#39;s creation method was ´manual´
  # @param suppression_id ID of Suppression List
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_suppression_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
