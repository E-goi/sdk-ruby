...
# Unit tests for EgoiRubyClient::RequestItemsUnsubscribe
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::RequestItemsUnsubscribe do
  let(:instance) { EgoiRubyClient::RequestItemsUnsubscribe.new }

  describe 'test an instance of RequestItemsUnsubscribe' do
    it 'should create an instance of RequestItemsUnsubscribe' do
      expect(instance).to be_instance_of(EgoiRubyClient::RequestItemsUnsubscribe)
    end
  end
