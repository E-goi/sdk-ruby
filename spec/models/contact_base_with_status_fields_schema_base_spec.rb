...
# Unit tests for EgoiRubyClient::ContactBaseWithStatusFieldsSchemaBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::ContactBaseWithStatusFieldsSchemaBase do
  let(:instance) { EgoiRubyClient::ContactBaseWithStatusFieldsSchemaBase.new }

  describe 'test an instance of ContactBaseWithStatusFieldsSchemaBase' do
    it 'should create an instance of ContactBaseWithStatusFieldsSchemaBase' do
      expect(instance).to be_instance_of(EgoiRubyClient::ContactBaseWithStatusFieldsSchemaBase)
    end
  end
