...
# Unit tests for EgoiRubyClient::ContactBaseWithStatusNoRemovedFieldsSchemaBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::ContactBaseWithStatusNoRemovedFieldsSchemaBase do
  let(:instance) { EgoiRubyClient::ContactBaseWithStatusNoRemovedFieldsSchemaBase.new }

  describe 'test an instance of ContactBaseWithStatusNoRemovedFieldsSchemaBase' do
    it 'should create an instance of ContactBaseWithStatusNoRemovedFieldsSchemaBase' do
      expect(instance).to be_instance_of(EgoiRubyClient::ContactBaseWithStatusNoRemovedFieldsSchemaBase)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["active", "inactive", "unconfirmed"])
