...
# Unit tests for EgoiRubyClient::User
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::User do
  let(:instance) { EgoiRubyClient::User.new }

  describe 'test an instance of User' do
    it 'should create an instance of User' do
      expect(instance).to be_instance_of(EgoiRubyClient::User)
    end
  end
