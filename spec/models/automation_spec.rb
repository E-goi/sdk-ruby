...
# Unit tests for EgoiRubyClient::Automation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::Automation do
  let(:instance) { EgoiRubyClient::Automation.new }

  describe 'test an instance of Automation' do
    it 'should create an instance of Automation' do
      expect(instance).to be_instance_of(EgoiRubyClient::Automation)
    end
  end
