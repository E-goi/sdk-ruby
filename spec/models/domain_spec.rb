...
# Unit tests for EgoiRubyClient::Domain
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::Domain do
  let(:instance) { EgoiRubyClient::Domain.new }

  describe 'test an instance of Domain' do
    it 'should create an instance of Domain' do
      expect(instance).to be_instance_of(EgoiRubyClient::Domain)
    end
  end
