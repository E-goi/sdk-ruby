...
# Unit tests for EgoiRubyClient::ContactInsideBaseBulk
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::ContactInsideBaseBulk do
  let(:instance) { EgoiRubyClient::ContactInsideBaseBulk.new }

  describe 'test an instance of ContactInsideBaseBulk' do
    it 'should create an instance of ContactInsideBaseBulk' do
      expect(instance).to be_instance_of(EgoiRubyClient::ContactInsideBaseBulk)
    end
  end
