...
# Unit tests for EgoiRubyClient::ContactCampaignActivity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::ContactCampaignActivity do
  let(:instance) { EgoiRubyClient::ContactCampaignActivity.new }

  describe 'test an instance of ContactCampaignActivity' do
    it 'should create an instance of ContactCampaignActivity' do
      expect(instance).to be_instance_of(EgoiRubyClient::ContactCampaignActivity)
    end
  end
