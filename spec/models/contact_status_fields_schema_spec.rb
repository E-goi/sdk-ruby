...
# Unit tests for EgoiRubyClient::ContactStatusFieldsSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::ContactStatusFieldsSchema do
  let(:instance) { EgoiRubyClient::ContactStatusFieldsSchema.new }

  describe 'test an instance of ContactStatusFieldsSchema' do
    it 'should create an instance of ContactStatusFieldsSchema' do
      expect(instance).to be_instance_of(EgoiRubyClient::ContactStatusFieldsSchema)
    end
  end
