...
# Unit tests for EgoiRubyClient::UnsubscriptionObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::UnsubscriptionObject do
  let(:instance) { EgoiRubyClient::UnsubscriptionObject.new }

  describe 'test an instance of UnsubscriptionObject' do
    it 'should create an instance of UnsubscriptionObject' do
      expect(instance).to be_instance_of(EgoiRubyClient::UnsubscriptionObject)
    end
  end
