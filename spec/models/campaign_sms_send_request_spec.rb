...
# Unit tests for EgoiRubyClient::CampaignSmsSendRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CampaignSmsSendRequest' do
  before do
    # run before each test
    @instance = EgoiRubyClient::CampaignSmsSendRequest.new
  end
  ...
  describe 'test an instance of CampaignSmsSendRequest' do
    it 'should create an instance of CampaignSmsSendRequest' do
      expect(@instance).to be_instance_of(EgoiRubyClient::CampaignSmsSendRequest)
    end
  end
