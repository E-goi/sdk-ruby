...
# Unit tests for EgoiRubyClient::OSegmentsActionSend
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OSegmentsActionSend' do
  before do
    # run before each test
    @instance = EgoiRubyClient::OSegmentsActionSend.new
  end
  ...
  describe 'test an instance of OSegmentsActionSend' do
    it 'should create an instance of OSegmentsActionSend' do
      expect(@instance).to be_instance_of(EgoiRubyClient::OSegmentsActionSend)
    end
  end
