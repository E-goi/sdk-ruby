...
# Unit tests for EgoiRubyClient::Webhook
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::Webhook do
  let(:instance) { EgoiRubyClient::Webhook.new }

  describe 'test an instance of Webhook' do
    it 'should create an instance of Webhook' do
      expect(instance).to be_instance_of(EgoiRubyClient::Webhook)
    end
  end
