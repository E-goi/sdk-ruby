...
# Unit tests for EgoiRubyClient::ContentVoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContentVoice' do
  before do
    # run before each test
    @instance = EgoiRubyClient::ContentVoice.new
  end
  ...
  describe 'test an instance of ContentVoice' do
    it 'should create an instance of ContentVoice' do
      expect(@instance).to be_instance_of(EgoiRubyClient::ContentVoice)
    end
  end
