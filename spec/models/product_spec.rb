...
# Unit tests for EgoiRubyClient::Product
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::Product do
  let(:instance) { EgoiRubyClient::Product.new }

  describe 'test an instance of Product' do
    it 'should create an instance of Product' do
      expect(instance).to be_instance_of(EgoiRubyClient::Product)
    end
  end
