...
# Unit tests for EgoiRubyClient::Order
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::Order do
  let(:instance) { EgoiRubyClient::Order.new }

  describe 'test an instance of Order' do
    it 'should create an instance of Order' do
      expect(instance).to be_instance_of(EgoiRubyClient::Order)
    end
  end
