...
# Unit tests for EgoiRubyClient::AcceptedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::AcceptedResponse do
  let(:instance) { EgoiRubyClient::AcceptedResponse.new }

  describe 'test an instance of AcceptedResponse' do
    it 'should create an instance of AcceptedResponse' do
      expect(instance).to be_instance_of(EgoiRubyClient::AcceptedResponse)
    end
  end
