...
# Unit tests for EgoiRubyClient::ContactOtherActivity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::ContactOtherActivity do
  let(:instance) { EgoiRubyClient::ContactOtherActivity.new }

  describe 'test an instance of ContactOtherActivity' do
    it 'should create an instance of ContactOtherActivity' do
      expect(instance).to be_instance_of(EgoiRubyClient::ContactOtherActivity)
    end
  end
