...
# Unit tests for EgoiRubyClient::CampaignPushSendRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CampaignPushSendRequest' do
  before do
    # run before each test
    @instance = EgoiRubyClient::CampaignPushSendRequest.new
  end
  ...
  describe 'test an instance of CampaignPushSendRequest' do
    it 'should create an instance of CampaignPushSendRequest' do
      expect(@instance).to be_instance_of(EgoiRubyClient::CampaignPushSendRequest)
    end
  end
