...
# Unit tests for EgoiRubyClient::ContactInsideBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::ContactInsideBase do
  let(:instance) { EgoiRubyClient::ContactInsideBase.new }

  describe 'test an instance of ContactInsideBase' do
    it 'should create an instance of ContactInsideBase' do
      expect(instance).to be_instance_of(EgoiRubyClient::ContactInsideBase)
    end
  end
