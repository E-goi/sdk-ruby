...
# Unit tests for EgoiRubyClient::DeleteSegmentsConflictsErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DeleteSegmentsConflictsErrors' do
  before do
    # run before each test
    @instance = EgoiRubyClient::DeleteSegmentsConflictsErrors.new
  end
  ...
  describe 'test an instance of DeleteSegmentsConflictsErrors' do
    it 'should create an instance of DeleteSegmentsConflictsErrors' do
      expect(@instance).to be_instance_of(EgoiRubyClient::DeleteSegmentsConflictsErrors)
    end
  end
