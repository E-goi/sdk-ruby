...
# Unit tests for EgoiRubyClient::CampaignPushContent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CampaignPushContent' do
  before do
    # run before each test
    @instance = EgoiRubyClient::CampaignPushContent.new
  end
  ...
  describe 'test an instance of CampaignPushContent' do
    it 'should create an instance of CampaignPushContent' do
      expect(@instance).to be_instance_of(EgoiRubyClient::CampaignPushContent)
    end
  end
