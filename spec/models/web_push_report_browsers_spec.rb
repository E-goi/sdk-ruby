...
# Unit tests for EgoiRubyClient::WebPushReportBrowsers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WebPushReportBrowsers' do
  before do
    # run before each test
    @instance = EgoiRubyClient::WebPushReportBrowsers.new
  end
  ...
  describe 'test an instance of WebPushReportBrowsers' do
    it 'should create an instance of WebPushReportBrowsers' do
      expect(@instance).to be_instance_of(EgoiRubyClient::WebPushReportBrowsers)
    end
  end
