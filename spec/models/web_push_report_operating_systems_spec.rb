...
# Unit tests for EgoiRubyClient::WebPushReportOperatingSystems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WebPushReportOperatingSystems' do
  before do
    # run before each test
    @instance = EgoiRubyClient::WebPushReportOperatingSystems.new
  end
  ...
  describe 'test an instance of WebPushReportOperatingSystems' do
    it 'should create an instance of WebPushReportOperatingSystems' do
      expect(@instance).to be_instance_of(EgoiRubyClient::WebPushReportOperatingSystems)
    end
  end
