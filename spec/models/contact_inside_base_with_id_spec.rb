...
# Unit tests for EgoiRubyClient::ContactInsideBaseWithId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EgoiRubyClient::ContactInsideBaseWithId do
  let(:instance) { EgoiRubyClient::ContactInsideBaseWithId.new }

  describe 'test an instance of ContactInsideBaseWithId' do
    it 'should create an instance of ContactInsideBaseWithId' do
      expect(instance).to be_instance_of(EgoiRubyClient::ContactInsideBaseWithId)
    end
  end
